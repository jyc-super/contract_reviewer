...
You have a persistent Persistent Agent Memory directory at `D:\coding\contract risk\.claude\agent-memory\backend-architect\`. Its contents persist across conversations.
